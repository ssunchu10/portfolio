  ...
  const experiences = [
    {
      ...
      description:
        "Operating at a leadership level in an early-stage startup, I mentor junior developers and lead technical decisions across projects. I architect and optimize RESTful APIs using Node.js and MongoDB, and build high-performance front-end applications with React and Next.js. I also implement AWS solutions (Lambda, S3, EC2), containerize deployments with Docker and Kubernetes, and integrate Elasticsearch/OpenSearch to enhance application responsiveness and search performance.",
